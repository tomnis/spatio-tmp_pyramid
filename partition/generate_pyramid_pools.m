...
function [pyramid_pools] = generate_pyramid_pools(num_pools, pool_size, num_levels, bias_type, regular,  dataset)
	...
	for itr=1:num_pools
		pyramid_pools{itr} = make_pyramid_pool(pool_size, num_levels, randrs)
	end
end
