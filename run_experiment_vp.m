...
function [accuracies, all_confns, all_fs] = run_experiment_vp(allpools, bias_type, kernel_type, trials,split60)
	load loaded_data;
	...
	for i=1:length(trials)
		...
		for j=1:num_pools
			...
			d = boost_main_vary_boostrounds(pools(j), traindata, testdata, kernel_type, dim, 5);
