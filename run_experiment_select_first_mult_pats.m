...
function [accuracies, all_confns, all_fs] = run_experiment_select_first_mult_pats(allpools, bias_type, kernel_type, trials,split60)
	load loaded_data;
	...
	for i=1:length(trials)
		...
		for j=1:num_pools
			...
			d = boost_main_select_first_mult_pats(pools(j), traindata, testdata, kernel_type, dim);
