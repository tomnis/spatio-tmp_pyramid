...
function [accuracies, all_confns, all_fs] = run_experiment_1vall(allpools, bias_type, kernel_type, trials,split60)
	load loaded_data;
  ...
  %{
  %%%% TODO remove this, debug status on 3/30
  for i=1:1
    p{1}{i} = pools{1}{i};
  end
  pools = p;
  %%%% TODO remove this, debug status on 3/30
	...
	for i=1:length(trials)
		...
		for j=1:num_pools
			...
			d = boost_main_1vall(pools(j), traindata, testdata, kernel_type, dim);
