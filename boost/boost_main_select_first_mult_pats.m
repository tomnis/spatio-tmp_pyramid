...
function [d] = boost_main_select_first_mult_pats(pools, traindata, testdata, kernel_type, dim)
	...
	for itr=1:num_itrs
		...
		f = boost_select_first_mult_pats(traindata, pool, target_accuracy, dim, kernel_type);
